...
export default function App() {
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--bg-primary)" }}>
      ...
      <main className="max-w-md mx-auto px-4 py-5 pb-20 space-y-4">
            ...
            >
              ...
              <div className="card p-4 relative overflow-hidden text-center">
                ...
                <p className="text-xs text-muted leading-relaxed">
                  <strong className="text-ink2">Pariwara</strong> bantu kamu bikin strategi iklan yang
                  tepat sasaran — cocok untuk pelaku Ekraf Indonesia. Isi 4 langkah, langsung dapat
                  panduan lengkap: platform terbaik, cara nulis iklan, hingga strategi jualan di marketplace.
                </p>
              </div>
